...
<h1>Ephemeral Certificates</h1>

<div class="alert alert-info">
	<strong>⚡ Ephemeral View:</strong> Short-lived certificates (WiFi, IoT devices, temporary access).
	<br>Thresholds: <span style="color: red;">Critical ≤10% lifetime</span>, <span style="color: orange;">Warning ≤30% lifetime</span>, <span style="color: blue;">Notice ≤50% lifetime</span>
</div>

<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">Ephemeral Certificates (Percentage Thresholds)</h3>
	</div>
	<div class="panel-body">
		<% if view.count then %>
		<p>Total Ephemeral Certificates: <strong><%= html.html_escape(view.count.value) %></strong></p>
		<% end %>
