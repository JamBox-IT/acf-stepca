...
<h1>Infrastructure Certificates</h1>

<div class="alert alert-info">
	<strong>🏛️ Infrastructure View:</strong> Long-lived certificates (CA, Server, Client, Client-Server).
	<br>Thresholds: <span style="color: red;">Critical ≤7 days</span>, <span style="color: orange;">Warning ≤30 days</span>, <span style="color: blue;">Notice ≤90 days</span>
</div>

<div class="panel panel-default">
	<div class="panel-heading">
		<h3 class="panel-title">Infrastructure Certificates (Fixed Day Thresholds)</h3>
	</div>
	<div class="panel-body">
		<% if view.count then %>
		<p>Total Infrastructure Certificates: <strong><%= html.html_escape(view.count.value) %></strong></p>
		<% end %>
